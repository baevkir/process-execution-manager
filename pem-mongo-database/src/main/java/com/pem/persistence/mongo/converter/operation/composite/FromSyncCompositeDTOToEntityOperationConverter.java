...
public class FromSyncCompositeDTOToEntityOperationConverter extends ConverterTemplateMethods implements Converter<SyncCompositeOperationDTO, SyncCompositeOperationEntity> {
    ...
    public SyncCompositeOperationEntity convert(SyncCompositeOperationDTO source) {
        ...
        for (OperationDTO operationDTO : source.getOperations()) {
