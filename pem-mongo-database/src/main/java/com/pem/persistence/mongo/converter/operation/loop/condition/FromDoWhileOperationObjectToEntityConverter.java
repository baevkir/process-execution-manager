...
public class FromDoWhileOperationObjectToEntityConverter extends ConverterTemplateMethods implements Converter<DoWhileLoopOperationObject, DoWhileLoopOperationEntity> {

    private ConverterFactory converterFactory;

    @Override
    public DoWhileLoopOperationEntity convert(DoWhileLoopOperationObject source) {
