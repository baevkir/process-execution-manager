package com.pem.common.converter.operation.composite;
...
public class SyncCompositeOperationConverter extends AbstractOperationConverter<SyncCompositeOperationEntity> {
    ...
    private com.pem.common.converter.ConverterFactory converterFactory;

    public void setConverterFactory(com.pem.common.converter.ConverterFactory converterFactory) {
